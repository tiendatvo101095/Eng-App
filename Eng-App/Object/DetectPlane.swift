...
//        let cupNode = SCNNode(geometry: self.planeGeometry)
//        cupNode.position = SCNVector3(anchor.center.x, 0, anchor.center.z)
//        guard SCNScene(named: "RockPigeon.scn", inDirectory: "Models.scnassets/RockPigeon") != nil else {
//            return
//        }
    ...
    func initializePlaneMaterial() -> SCNMaterial {
        ...
        material.diffuse.contents = UIColor.white.withAlphaComponent(1.0)
        return material
    }
